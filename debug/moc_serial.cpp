...
QT_MOC_LITERAL(1, 9, 15), // "sig_SendTipInfo"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 6), // "result"
QT_MOC_LITERAL(4, 33, 4), // "info"
QT_MOC_LITERAL(5, 38, 16), // "sig_SendReadData"
QT_MOC_LITERAL(6, 55, 4) // "data"

    },
    "MySerial\0sig_SendTipInfo\0\0result\0info\0"
    "sig_SendReadData\0data"
};
...
void MySerial::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sig_SendTipInfo((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 1: _t->sig_SendReadData((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (MySerial::*_t)(bool , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MySerial::sig_SendTipInfo)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (MySerial::*_t)(QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MySerial::sig_SendReadData)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MySerial::sig_SendTipInfo(bool _t1, QString _t2)
{
...
// SIGNAL 1
void MySerial::sig_SendReadData(QByteArray _t1)
{
